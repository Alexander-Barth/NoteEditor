...
function loadexample() {
    ...
    // var data = {"clef":"treble","tracks":[[[{"n":10,"length":8,"id":4}],[{"n":15,"length":8,"id":5}],[{"n":15,"length":8,"id":6}],[{"n":22,"length":8,"id":7}],[{"n":22,"length":8,"id":8}],[{"n":19,"length":8,"id":9}],[{"n":19,"length":8,"id":10}],[{"n":15,"length":8,"id":11}],[{"n":15,"length":8,"id":12}],[{"n":17,"length":8,"id":13}],[{"n":17,"length":8,"id":14}],[{"n":10,"length":8,"id":15}],[{"n":10,"length":8,"id":16}],[{"n":15,"length":8,"id":17}],[{"n":15,"length":16,"id":18}],[{"n":19,"length":16,"id":19}],[{"n":22,"length":8,"id":20}]]]};
